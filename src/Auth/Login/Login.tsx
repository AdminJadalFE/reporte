...
const Login = () => {
  ...
  const RouteChange = () => {
    ...
    let path = `${import.meta.env.BASE_URL}sire/periods/`;
    navigate(path);
  };
                          ...
                          <CardBody className="">
                            ...
                            <div className="btn-list d-lg-flex">
                              <a
                                ...
                                target="_blank"
                                className="btn btn-danger btn-w-lg d-block"
                              >
                                Google
                              </a>
                              <a
                                ...
                                target="_blank"
                                className="btn btn-info d-lg-inline d-block"
                              >
                                Twitter
                              </a>
                              <a
                                ...
                                target="_blank"
                                className="btn btn-primary d-lg-inline d-block me-2"
                              >
                                Facebook
                              </a>
                            </div>
                          ...
                          <InputGroup className="input-group mb-4">
                            ...
                            <Col className="col-12">
                              <Button
                                ...
                                onClick={Login}
                              >
                                <i className="fe fe-arrow-right"></i> Iniciar Sesión
                                {loading ? (
                                  <span
                                    role="status"
                                    aria-hidden="true"
